# GitHub mirror of `MacJev-322M-4K-Laya`

This repository mirrors the public Hugging Face model at:

<https://huggingface.co/chaoliangUNSW/MacJev-322M-4K-Laya>

Files smaller than 100 MiB are stored on the `main` branch. Larger model files are attached to the GitHub Release:

<https://github.com/lawrence3699/MacJev-322M-4K-Laya/releases/tag/huggingface-snapshot-2026-09-23>
